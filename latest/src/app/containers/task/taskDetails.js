                                            ...
                                            {this.state.UserType === 'admin' ?
                                                <div> <hr />
                                                    {assing_to === 'teams' ? is_randomized ? !is_judge_locked ? <button className="btn btn-md btn-primary text-center mr-2" onClick={() => this.randomizeJudgesAgain()}>Radomize judge again</button>
                                                        : <button className="btn btn-md btn-primary text-center mr-2" disabled><i class="fas fa-lock"></i>Judges locked</button> : <button className="btn btn-md btn-primary text-center mr-2" onClick={() => this.randomizeJudges()}>Begin randomize judges</button> : ''}

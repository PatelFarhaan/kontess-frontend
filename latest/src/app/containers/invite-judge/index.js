...
export default class InviteMember extends React.Component {
    ...
    render() {
        ...
        return (
            <DashboardTemplate title={userType === 'admin' ? 'Add Judge/Coach in Team' : 'Invite Judge/Coach For Team'} pageId="team_info">
                                                ...
                                                <div className="card-body border-o">
                                                    <div className="row justify-content-between align-items-center">
                                                        ...
                                                        <div className="col-md-2 text-center">
                                                            <button className="btn btn-md btn-primary px-4 rounded-0" onClick={() => this.sendInvitaion(participant, index)} > {userType === 'admin' ? 'Add Judge/Coach in Team' : 'Send Invitation'}</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>

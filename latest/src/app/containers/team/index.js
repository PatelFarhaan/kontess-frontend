              ...
              <div className="row justify-content-between">
                ...
                <div className="col-9">
                  <div className="tab-content" id="v-pills-tabContent">
                    ...
                    >
                      ...
                      <div className="border border-secondary p-2">
                        ...
                        <div className="text-right">
                          <button
                            className="bg-transparent btn btn-md border border-secondary text-secondary mx-2"
                    ...
                    >
                      <h2 className="intro text-secondary">
                        <u>Introduction</u>
                      </h2>
                      ...
                      <div className="border border-secondary mx-5 my-4">
                        <p className="p-5 text-center">
                          Introductory Video, photos, slideshow...
                        </p>
                      </div>
                    </div>
                    <div

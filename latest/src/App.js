...
import TeamList from "./app/containers/team-list/TeamList";
          ...
          <div>
            <Switch>
              <Route
                path="/registration"
                component={(props) => (
                  <NewRegistratoin checkAuth={this.checkAuth} />
                )}
              />
              <PrivateRoute
                pathName={"/"}
                isAuthenticated
                path="/judge_plateform"
                component={JudgePlateform}
              />
                ...
                render={({ match: { path } }) => (
                  <>
                    ...
                    <PrivateRoute
                      pathName={"/"}
                      isAuthenticated={this.state.isAuthenticated}
                      path={`${path}/invite_members/:teamId`}
                    ...
                    <PrivateRoute
                      ...
                      path={`${path}/settings`}
                      component={(props) => (
                        <Settings onChangeTheme={() => this.onChangeTheme()} />
                      )}
                    />
                    <PrivateRoute
                      pathName={"/"}
                    ...
                    <PrivateRoute
                      pathName={"/"}
                      isAuthenticated={this.state.isAuthenticated}
                      path={`${path}/create-team-event/:teamId`}
                      component={TeamEvent}
                    />
                    <PrivateRoute
                      pathName={"/"}
                      isAuthenticated={this.state.isAuthenticated}
                      path={`${path}/edit-team-event/:teamId/:eventId`}
                      component={TeamEvent}
                    />
                    <PrivateRoute
                      pathName={"/"}
                      isAuthenticated={this.state.isAuthenticated}
                      path={`${path}/create-team-task/:teamId`}
                      component={TeamTask}
                    />
                    <PrivateRoute
                      pathName={"/"}
                      isAuthenticated={this.state.isAuthenticated}
                      path={`${path}/edit-team-task/:teamId/:taskId`}
                      component={TeamTask}
                    />
                    <PrivateRoute
                      pathName={"/"}
                      isAuthenticated={this.state.isAuthenticated}
                      path={`${path}/pending-requests`}
                      component={PendingRequests}
                    />
                    <PrivateRoute
                      pathName={"/"}
                      isAuthenticated={this.state.isAuthenticated}
                      path={`${path}/invite_judge/:teamId`}
                    ...
                    <PrivateRoute
                      pathName={"/"}
                      isAuthenticated={this.state.isAuthenticated}
                      path={`${path}/create-task`}
                      component={CreateModifyTask}
                    />
                    <PrivateRoute
                      pathName={"/"}
                      isAuthenticated={this.state.isAuthenticated}
                      path={`${path}/modify-task/:taskId`}
                      component={CreateModifyTask}
                    />
                    <PrivateRoute
                      pathName={"/"}
                      isAuthenticated={this.state.isAuthenticated}
                      path={`${path}/task-view/:taskId`}
                      component={
                        session.getUserType() === "admin"
                          ? TaskDetails
                          : session.getUserType() === "judge"
              ...
              <Route
                path="/"
                component={(props) => (
                  <NewLogin checkAuth={(state) => this.checkAuth(state)} />
                )}
              />
            </Switch>
          </div>

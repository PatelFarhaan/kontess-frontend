...
const Footer = () => (
  <footer>
    ...
    <span>
      <a
        href={
          "https://www.facebook.com/Jiffal/?view_public_for=402512323491534"
        }
        target={"_blank"}
      ...
      <a
        href={"https://www.instagram.com/jiffal/"}
        target={"_blank"}
        rel={"noopener noreferrer"}
      >
    ...
    <a
      href={
        "https://docs.google.com/forms/d/e/1FAIpQLScJfW3kMg933fBCWOh4rvITq20m8xWSsnHpoOtagNnS86b-gA/viewform"
      }
      target={"_blank"}
      rel={"noopener noreferrer"}
    >
      Help us improve Kontess
    </a>
  </footer>
);

    ...
    return (
      <div className="header-area">
        <div className="row align-items-center">
          <div className="col-md-6 col-sm-5 d_none_sm d-flex pt-2">
            <div className="position-relative">
              <div className="nav-btn pull-left d-none d-lg-block position-relative mr-0">
                <span class="side-bars"></span>
                <span class="side-bars"></span>
                <span class="side-bars"></span>
              </div>
              {msgCount !== 0 ? (
                <span className="notificationBadge d-none">
                  {msgCount ? msgCount : 0}
                </span>
              ) : (
                  ''
          ...
          <div className="col-md-6 col-sm-7">
            <ul className="notification-area list-inline d-flex justify-content-end align-items-center mb-0">
              <li className="d-lg-none d-block position-relative">
                <div className="position-relative">

            ...
            <div className="comment-widgets">
              <a key={request.id} className="notify-item">
                ...
                <div className="notify-text">
                  ...
                  {request.judge_status === 'pending' ? <span className="badge badge-info mr-1 mt-1">Judge Approval Pending</span> : request.judge_status === 'approved' ? <span className="badge badge-success mr-1 mt-1">Approved by Judge</span> : <span className="badge badge-danger mr-1 mt-1">Rejected by Judge</span>}
                  <div>
                    <span>
                      <Moment

                                                    ...
                                                    <div className="d-flex flex-row comment-row border-0 p-1">
                                                        <div className="tesk-detail w-100 border-0 ml-0 pl-0">
                                                            <div>
                                                                ...
                                                                {userType === 'judge' ? <span className={`ml-2 badge badge-pill ${task.assing_to && task.assing_to === 'teams' ? 'badge-info' : 'badge-warning'}`} >{task.assing_to && task.assing_to === 'teams' ? '(Team)' : '(Individual)'}</span>

...
export default class Grading extends React.Component {
    ...
    render() {
        const { title, questions, over_all_comments, taskTitle, track } = this.state;
        return (
                                    ...
                                    ? questions.map((item, index) => (
                                        <div className="row justify-content-between my-4">
                                            ...
                                            <div className="col-md-4 d-flex justify-content-center align-items-center">
                                                <input name="score" value={questions[index].score} onChange={(e) => this.submitGrading(e, index)} type="number" min="0" max={item.max_score} className="form-control mx-1 border-grey w-25" required />
                                                <p className="m-0 pl-2 text-blue font-weight-bold">out of {item.max_score}</p>
                                            </div>
                                            <div className="col-md-2">
                                                <input name="comment" value={questions[index].comment} onChange={(e) => this.submitGrading(e, index)} type="text" autoComplete="off" className="form-control mx-1 border-grey" />
                                            </div>
                                        </div>
                                    ))
                                    : ''}
                                <div className="row">
                                    <div className="col-md-12 my-3">
                                        <div className="form-group">
                                            <label className="h6 font-weight-bold text-blue" for="comment">Overall Comment</label>

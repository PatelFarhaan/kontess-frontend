...
export default class NewEvent extends React.Component {
    ...
    componentWillReceiveProps(nextProps) {
        if (nextProps.event) {
            this.setState({
                ...
                schedule_date: moment(nextProps.event.schedule_date, 'YYYY-MM-DD HH:mm A'),
                ...
                document.getElementById("judges").checked = nextProps.event.attendees === 'both' || nextProps.event.attendees === 'judges' ? true : false;
                document.getElementById("participants").checked = nextProps.event.attendees === 'both' || nextProps.event.attendees === 'participants' ? true : false;
            })
        } else {
    ...
    submit = async event => {
        ...
        const { title, description, schedule_date, location, attendees, date } = self.state;
    ...
    setAttendees = async () => {
        let checkedAttendees = await document.querySelectorAll('.attendees:checked');
                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title">{this.state.id ? 'Update' : 'Add new'} event</h5>
                        ...
                        <form onSubmit={this.submit} id="newEventForm" >
                            <div className="modal-body">
                                <div className="new-task-form">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <div className="col-md-12"><DateTimePicker variant="inline" disablePast value={this.state.date} onChange={this.selectDate} /></div>
                                    </div>
                                    <div className="form-group">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <div className="custom-control custom-checkbox primary-checkbox custom-control-inline">
                                            <input
                                                ...
                                                id="judges"
                                            />
                                            <label className="custom-control-label c2 ml-2" for="judges">
                                                Judges </label>
                                        </div>
                                        <div className="custom-control custom-checkbox primary-checkbox custom-control-inline">
                                            <input
                                                ...
                                                name="attendees"
                                            />
                                            <label className="custom-control-label c2 ml-2" for="participants">
                                                Participant </label>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="modal-footer">
                                ...
                                {this.state.id ? <button type="button" onClick={() => this.deleteEvent()} className="btn btn-danger">
                                    Delete  </button> : ''}

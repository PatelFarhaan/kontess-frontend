            ...
            .then(resp => {
                if (resp.data) {
                    self.setState({
                        ...
                        schedule_date: resp.data.schedule_date,
                        date: new Date(resp.data.schedule_date),
                        minDate: new Date(resp.data.schedule_date) > new Date() ? new Date() : new Date(resp.data.schedule_date),
                        pastEvent: new Date(resp.data.schedule_date) > new Date() ? false : true,
                                                        ...
                                                        {teamInfo && teamInfo.team_mentor.admin_status === 'approved' && teamInfo.team_mentor.judge_status === 'approved' ?
                                                            <div className="form-group">
                                                                <div className="row justify-content-center">
                                                                    <div className="col-md-9">
                                                                        <div className="assigned-members d-flx justify-content-between align-items-center mb-3">
                                                                            <h5 className="d-inline-block">Invite Judge</h5>
                                                                        </div>
                                                                        <ul className="members-list list-group list-group-flush px-5">

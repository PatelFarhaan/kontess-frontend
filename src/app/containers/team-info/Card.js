              ...
              <div className="row justify-content-between align-items-center">
                  ...
                  <div className="col-md-2 text-center">
                    {this.checkStatus(team.partipants) === false ?
                      team.status === 'pending' ?
                        ...
                        : <button className="btn btn-md btn-primary btn-block w-100" onClick={() => this.sendJoinRequest(team.id, team.partipants.length)}>Join as participant</button>
                      ...
                      {team.team_mentor.id ?
                        team.team_mentor.id === this.state.curruntUserId ?
                          team.team_mentor.admin_status === 'approved' && team.team_mentor.judge_status === 'approved' ?
                            <span className="badge badge-success">Joined as judge</span>
                            : <span className="badge badge-warning">your approval is pending</span>
                          : team.team_mentor.admin_status === 'approved' && team.team_mentor.judge_status === 'approved' ?
                            ''
                            : <span className="badge badge-info">{team.team_mentor.full_name} is requested for join as judge</span>
                        : <button className="btn btn-md btn-primary btn-block w-100" onClick={() => this.sendJoinRequest(team.id, team.partipants.length)}>Join as judge</button>
                      }
                ...
                <div className="col-md-4">
                  ...
                  <div className="d-flex mt-2 justify-content-start align-items-center">
                    <p className="m-0 mr-1 w-15">Mentor</p>
